...
Account quota windows come only from the providers' live usage endpoints. If a refresh fails, Konvu reports them as unavailable instead of reusing a transcript or hook-derived value that may be stale.
